...
function FavoriteCard({ id,name, rating, imageUrl, address, priceRange }) {
  ...
  return (
    <div className="cursor-pointer transform transition-transform duration-300 hover:scale-105 flex flex-col" onClick={() => navigate(`/detail/${id}`, { state: { id } })}>
